...
public class main {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		URL url = new URL("http://localhost:8080/UC?wsdl");
		 QName qname = new QName("http://service.soa.kps.cpe.eng.kps.ku.ac.th/",
		 "UnitConversionImplService");
		 Service service = Service.create(url, qname);
		 qname = new QName("http://service.soa.kps.cpe.eng.kps.ku.ac.th/",
		"UnitConversionImplPort");
		 UnitConverstion uc = service.getPort(qname, UnitConverstion.class);
